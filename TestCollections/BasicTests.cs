...
namespace CSharpTest.Net.BPlusTree.Test
{
    ...
    public class BasicTests
    {
        ...
        static IEnumerable<KeyValuePair<int, string>> CreateRandom(int count, int max)
        {
        ...
        static IEnumerable<KeyValuePair<int, string>> CreateCount(int start, int increment, int count)
        {
            for (int i = 0; i < count; i++)
            {
